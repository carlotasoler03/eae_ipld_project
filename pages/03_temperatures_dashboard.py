...
if unique_countries_list is not None and len(selected_cities) > 0:
    ...
    plt.title(f"Temperature selected cities from {start_date} to {end_date}")   # TODO
    ...
    plt.title(f"Histogram temperatures for list of cities from {start_date} to {end_date}")   # TODO
